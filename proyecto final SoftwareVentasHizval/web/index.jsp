...
<html lang="en">
    <head>
        ...
        <title>SV-Vinos Hizval</title>
    </head>
    <body style= "background: url('fondoHizval.png') no-repeat; background-size: cover;">
        <br>
        <h1 style="text-align: center; color: white; -webkit-text-stroke: 1px black; ">Bien Venidos</h1>
        <h1 style="text-align: center; color: white; -webkit-text-stroke: 1px black; ">Sistema de Ventas en Vinos Hizval</h1>
